		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav
					...
					<div id="wrap" style="position:absolute;display:none;width:100%;margin-left:15px;padding-right:14px;margin-top:280px;z-index:10000;"></div>
				...
				<div class="container-fluid">
					...
					<div id="map" style="width: 100%; height: 686px;"></div>
